      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-0 mx-auto col-12 heading-main text-center mb-4 mb-5">
            <h2 className="mb-2">
              Our <span>Drupal Maintenance Plans</span>
            </h2>
            <p>
              We offer flexible Drupal maintenance plans tailored to your
              business needs. Whether you need basic updates, full-scale
              maintenance, or 24/7 support, we have a package that fits your
              budget.
            </p>
          </div>
        </div>
