...
const RemarkSeoCounter = () => {
  ...
  return (
    <section
      className="counter-main remark-seo-counter py-5"
      ref={counterRef}
    >
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
            Proven Results with <span>Google Ads Remarketing</span>
            </h2>
            <p className="my-3">
            Trust the numbers to work for you.
            </p>
          </div>
        </div>
        <div className="row">
...
export default RemarkSeoCounter;
