...
const CrmAutoCounter = () => {
  ...
  return (
    <section
      className="counter-main service-counter hubspot-counting crm-auto-counter py-5"
      ref={counterRef}
    >
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
              Why Hire WebGuruz for <br />
              <span>HubSpot CRM Automation?</span>
            </h2>
            <p>
              At WebGuruz, we bring deep expertise and certified HubSpot
              proficiency to your CRM needs. Our team is committed to helping
              you leverage HubSpot CRM automation to its fullest potential,
