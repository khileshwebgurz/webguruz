      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-0 mx-auto col-12 heading-main text-center mb-4 mb-5">
            <h2 className="mb-2">
              Our <span>Squarespace Maintenance Plans</span>
            </h2>
            <p>
              At WebGuruz Technologies, we offer flexible Squarespace
              maintenance plans designed to meet the needs of businesses of all
              sizes. Whether you need basic monthly maintenance or comprehensive
              ongoing support, we have a solution that fits your requirements
              and budget.
            </p>
          </div>
        </div>
