...
const YoutAdsCounter = () => {
  ...
  return (
    <section className="counter-main youtube-ads-counter py-5" ref={counterRef}>
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
              Creating <span> Excellence Together</span>
            </h2>
            <p className="my-3">
              At Webguruz, we empower your business to achieve outstanding
