...
const WordpressCounter = () => {
  ...
  return (
    <section className="counter-main wordpress-counter py-5" ref={counterRef}>
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            ...
            <p className="my-3">
              At WebGuruz Technologies Pvt Ltd, we deliver high-quality
              WordPress solutions backed by years of experience and expertise.
            </p>
          </div>
        </div>
        <div className="row">
          <div className="col col-xs-12">
            <label>
              {inView ? (
                <CountUp start={0} end={600} duration={1} suffix="+" />
              ) : (
                <span>1+</span>
              )}
          ...
          <div className="col col-xs-12">
            <label>
              ...
              <p>Skilled WordPress developers</p>
            </label>
          </div>
          <div className="col col-xs-12">
            <label>
          ...
          <div className="col col-xs-12">
            <label>
              {inView ? (
                <CountUp start={0} end={1200} duration={1} separator="" suffix="+" />
              ) : (
                <span>1+</span>
              )}
...
export default WordpressCounter;
