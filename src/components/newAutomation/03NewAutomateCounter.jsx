...
const NewAutomateCounter = () => {
  ...
  return (
    <section
      className="counter-main new-automation-counter py-5"
      ref={counterRef}
    >
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
              <span>Drive Efficiency, Save Time, </span> and Maximize ROI
            </h2>
            <p className="my-3">
              Partner with WebGuruz to unlock the true potential of marketing
              automation and scale your business effortlessly.
            </p>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col col-xs-12">
            <label>
              ...
              <p>Certified HubSpot professionals</p>
            </label>
          </div>
          <div className="col col-xs-12">
            <label>
...
export default NewAutomateCounter;
