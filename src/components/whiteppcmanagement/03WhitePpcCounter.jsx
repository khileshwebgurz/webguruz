...
const WhitePpcCounter = () => {
  ...
  return (
    <section className="counter-main white-ppc-counter py-5" ref={counterRef}>
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
              Achieve Outstanding Results with <br />
              WebGuruz&apos; <span> White Label PPC Services</span>
            </h2>
            <p className="my-3">
...
export default WhitePpcCounter;
