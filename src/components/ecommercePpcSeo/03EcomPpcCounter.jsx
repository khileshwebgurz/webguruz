...
const EcomPpcCounter = () => {
  ...
  return (
    <section
      className="counter-main ecommerce-ppc-counter py-5"
      ref={counterRef}
    >
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
            Increase Conversions & Maximize <br/>ROI with <span>eCommerce PPC</span>
            </h2>
            <p className="my-3">
