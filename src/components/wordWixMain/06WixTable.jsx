      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-0 mx-auto col-12 heading-main text-center mb-4 mb-5">
            <h2 className="mb-2">
              Our <span>Wix Maintenance Plans</span>
            </h2>
            <p>
              At WebGuruz Technologies, we understand that different businesses
              have different needs. That&apos;s why we offer flexible Wix
              maintenance plans that can be tailored to suit your specific
              requirements. Whether you need basic monthly maintenance or
              comprehensive daily support, we have options to fit your budget
              and business goals. All our plans include regular updates,
              security monitoring, performance optimization, and dedicated
