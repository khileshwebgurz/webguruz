      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-0 mx-auto col-12 heading-main text-center mb-4 mb-5">
            <h2 className="mb-2">
              Our <span>Joomla Maintenance Plans</span>
            </h2>
            <p>
              WebGuruz Technologies offers flexible Joomla maintenance plans
              designed to meet the needs of businesses of all sizes. Whether you
              need basic security updates or comprehensive 24/7 support, we have
              a solution that fits your requirements and budget. Our transparent
              pricing and no-hidden-fee policy ensures you always know exactly
