...
const SupportEcomCounter = () => {
  ...
  return (
    <section
      className="counter-main ecommerce-support-counter py-5"
      ref={counterRef}
    >
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            ...
            <p className="my-3">
              With years of excellence, WebGuruz has delivered outstanding
              results across the global eCommerce landscape.
            </p>
          </div>
        </div>
        <div className="row">
...
export default SupportEcomCounter;
