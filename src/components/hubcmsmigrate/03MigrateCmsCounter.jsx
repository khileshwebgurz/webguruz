...
const MigrateCmsCounter = () => {
  ...
  return (
    <section className="counter-main migrate-cms-counter py-5" ref={counterRef}>
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xs-12 heading-main text-center pb-0">
            <h2>
              Take the next step <span>with confidence</span>
            </h2>
            <p className="my-3">
              We combine technical expertise, personalized service, and
              strategic insight to make your website migration smooth and
              efficient.
            </p>
          </div>
        </div>
...
export default MigrateCmsCounter;
