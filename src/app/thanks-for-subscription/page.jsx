        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-xs-12 thankyou-content text-center">
              ...
              <h3>Thank You</h3>
              <p>
                Thank you for subscribing to our blog. We truly appreciate your
                interest and look forward to sharing valuable insights with you.
              </p>
...
export const metadata = {
  title: "Thank You for Subscribing to Our Blogs and Infographics!",
  description: "Thank you for subscribing! Get ready to explore our latest blogs and infographics on web development, digital marketing, HubSpot, and more.",
};
