...
export const metadata = {
  title: "Thank You for Contacting WebGuruz - We will Be in Touch Soon!",
  description:
    "Thanks for reaching out to WebGuruz! We will contact you shortly. In the meantime, feel free to visit our homepage for more information and updates.",
};